...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kkx93hw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kkx93hw.containers.anotherwebservice.com/
...
```
git clone git@github.com:amazingcoder345/container-kkx93hw.git
cd container-kkx93hw
```
...
```
docker attach container-kkx93hw
```
